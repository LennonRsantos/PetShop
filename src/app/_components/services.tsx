...
const services = [
    {
        title: "Banho & Tosa",
        description: "inclui banho com produtos específicos para o tipo de pelagem e pele do animal, cortes de unhas, limpeza das orelhas e tosa personalizada (higiênica ou estilizada).",
        duration: "1h",
        price: "$50",
        icon: <Scissors/>,
...
export function Services() {
    ...
    return (
        <section className="bg-[#2e005d] py-16">
            <div className="container mx-auto px-4">
                
                <h2 className="text-white text-center text-4xl font-bold mb-12">Nossos serviços</h2>
                                ...
                                <div key={index} className="flex-[0_0_100%] min-w-0 md:flex-[0_0_calc(100%/3)] px-3">
                                    <article className="bg-[#5c008b] text-white rounded-2xl p-6 space-y-4 h-full flex flex-col">
                                        ...
                                        <div className="border-t border-gray-700 pt-4  flex items-center justify-between">
                                            ...
                                            <a href="#" className="flex items-center justify-center gap-2 hover:bg-green-500 px-4 py-1 rounded-md duration-300">
