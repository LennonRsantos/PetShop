...
export function Hero(){
    return(
        <section className="bg-[#ff8300] text-white relative overflow-hidden">
        ...
        <div className="container mx-auto pt-16 pb-16 md:pb-0 px-4 relative">
            ...
            <article className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                    ...
                    <div>
                        <a data-aos="fade-up" data-aos-delay="500" href="#" target="_blank" className="bg-green-500 px-5 py-2 rounded-md font-semibold flex items-center justify-center w-fit gap-2">
